...
if (myRunningTotal < 21 && isGameGood == 1 && dealerBust !== 1 && dealerWon !== 1){
	  rl.question('Do you want to hit or stay? ', (answer) => {
			...
			afterHit = 1;
			hitMe();
			console.log(`Your running total is now: ${myRunningTotal} and the dealer has ${dealerRunningTotal}`);

			if (dealerRunningTotal > myRunningTotal && afterHit == 1){
 			       console.log(`The dealer has a better hand; you lose`);
			       rl.close();
			}
			if (afterHit == 1 && myRunningTotal > dealerRunningTotal && myRunningTotal <= 21){
			...
			if(myRunningTotal > 21 && afterHit == 1){
...
//			console.log(`now the used cards are ${usedCards}`);
			//hit comes before close
                        ...
                        rl.close();
			console.log(`Your running total stays at: ${myRunningTotal} and the dealer has ${dealerRunningTotal}`);
			if (dealerRunningTotal > myRunningTotal && dealerRunningTotal < 21){
                               console.log(`The dealer has a better hand; you lose`);
                               rl.close();
                        }
                        if (myRunningTotal > dealerRunningTotal){
                                console.log(`You won!`);
                                rl.close();
                        }
                        if (dealerRunningTotal == myRunningTotal){
